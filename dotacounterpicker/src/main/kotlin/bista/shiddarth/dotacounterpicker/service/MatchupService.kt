...
class MatchupService (private val counterService: CounterService){
    ...
    fun getWinner(heroName1: String, heroName2: String): Mono<MatchupWinner> {
        ...
        val heroId1 = counterService.getHeroIdFromHeroName(heroName1)
        val heroId2 = counterService.getHeroIdFromHeroName(heroName2)
        ...
        return response.filter { it.heroId == heroId2 }
            .map {heroStat->
                ...
                val winner = counterService.getHeroNameFromHeroId(heroIdWinner)
